...
export default function ExperienceAdmin() {
  ...
  const onSave = async () => {
    try {
      ...
      setSaving(true);
      if (editing) {
        await updateExperience(editing._id, data);
  ...
  return (
    <div>
      ...
      {loading ? (
        ...
        >
          No experience yet. Add your internship!
        </div>
      ) : (
            ...
            >
              ...
              >
                <div style={{ flex: 1 }}>
                  ...
                  >
                    <Tag color={TYPE_COLORS[exp.type] || "default"}>
                      {exp.type}
                    </Tag>
      ...
      >
        <Form form={form} layout="vertical" style={{ marginTop: 16 }}>
          <div className="exp-row-2">
            <Form.Item
              name="role"
              label={<span style={labelStyle}>Job Title / Role</span>}
              rules={[{ required: true }]}
            >
          ...
          <div className="exp-row-3">
            ...
            <Form.Item
              name="remote"
              label={<span style={labelStyle}>Remote</span>}
          ...
          <div className="exp-row-3">
            ...
            <Form.Item
              name="current"
              label={<span style={labelStyle}>Current Job</span>}
              valuePropName="checked"
            >
              <Switch
          ...
          <Form.Item
            name="highlights"
            label={<span style={labelStyle}>Highlights (one per line)</span>}
          >
            <Input.TextArea
              rows={4}
              placeholder={
